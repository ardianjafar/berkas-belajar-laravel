...
@section('container')
    ...
    @if ($posts->count())    
        <div class="card mb-3">
            <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->name }}" class="card-img-top h-50" alt="{{ $posts[0]->category->name }}">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p>
                        <small>
                            By . <a href="/posts?authors={{ $post->author->username }}" class="text-decoration-none">
                                {{ $post->author->name }}
                                </a>
